                ...
                <div className="flex flex-col gap-4 flex-1">
                    ...
                    <div className="flex flex-wrap gap-6">
                        <div className="flex items-center gap-2">
                            <input type="number" className="p-3 border-gray-300 rounded-lg" id="bedroom" min={'1'} max={'10'} required />
                            <span>Bedroom</span>
                        </div>
                        <div className="flex items-center gap-2">
                            <input type="number" className="p-3 border-gray-300 rounded-lg" id="bathroom" min={'1'} max={'10'} required />
                            <span>Bathroom</span>
                        </div>
                        <div className="flex items-center gap-2">
                            <input type="number" className="p-3 border-gray-300 rounded-lg" id="regularPrice" required />
                        ...
                        <div className="flex items-center gap-2">
                            <input type="number" className="p-3 border-gray-300 rounded-lg" id="discountedPrice" required />
                            <div className="flex flex-col items-center">
